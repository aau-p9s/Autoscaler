...
public class Runner
{
    ...
    public Runner(AppSettings appSettings, IServiceProvider provider, ILogger logger, KubernetesService kubernetes, PrometheusService prometheus, ForecasterService forecaster)
    {
