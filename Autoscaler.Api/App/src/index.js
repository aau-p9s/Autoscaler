  ...
  return (
    <div>
      <div className="nav-bar">
        <h2>Deployment Control Panel</h2>
        <button onClick={discoverDeployments} className="btn btn-primary">
      ...
      <div className="row">
        ...
        <div className="col-md-6 d-flex flex-column align-items-center divider-column colm p-5">
          ...
          {services
            .filter((service) => service.autoscalingEnabled === true)
            .map((service) => (
        ...
        <div className="col-md-6 d-flex flex-column align-items-center colm p-5">
          ...
          {services
            .filter((service) => service.autoscalingEnabled === false)
            .map((service) => (
              <div key={service.id} className="col-md-6 mb-5">
                <div className="card text-center p-3">
                  <h5>{service.name}</h5>
